...
vi.mock("@/features/meetings/actions/delete-meeting", () => ({ deleteMeetingAction: vi.fn() }));
...
describe("DeleteMeetingDialog", () => {
  it("requires an explicit command after naming the meeting", () => {
    render(<DeleteMeetingDialog meetingId="6b79f5f3-f083-4a75-b74b-41342f2b1454" title="Product weekly" />);
